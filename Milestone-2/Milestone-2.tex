...
\begin{longtable}{|p{2.5cm}|p{2.5cm}|p{10cm}|}
\hline
...
WEBREQ20 & Not Implemented & The web portal does not contain a FAQ and user guide. \\ \hline
\end{longtable}
...
APPREQ16 & Not Implemented & The application does not automatically display waypoint information when re-visited. \\ \hline
