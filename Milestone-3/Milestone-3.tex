...
Routes on walks effect walks and all related content, such as waypoints and reviews but not media, which requires a seperate multipart media request. 
...
Routes for waypoints effect the waypoint and its descriptions, but not any attached media. 
...
Walk reviews can be added and deleted, but they cannot be modified once they have been added to the database. 
